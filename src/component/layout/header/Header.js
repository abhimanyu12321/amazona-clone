        ...
        <>
            <div className="hidden md:flex header w-[100vw] bg-[#0f1111]  justify-between items-center h-[5rem] text-white gap-[20px] fixed z-10 ">
                ...
                <div className="headermid max-w-[700px] flex-grow-[1]">
                    <form className="headersearchBox flex justify-center items-center " onSubmit={searchSubmitHandler}>
                        <input
                            type="text"
                            placeholder="Search Amazon.in"
                            onChange={(e) => setKeyword(e.target.value)}
                            className='py-[15px] px-[4px] w-[100%] border rounded-tl-[10px] rounded-tr-none rounded-bl-[10px] rounded-br-none box-border outline-0 text-black'
                        />
                        <button type="submit"
            ...
            <div className="flex flex-col md:hidden header w-[100vw] bg-[#0f1111]  justify-center items-center text-white gap-[20px] fixed z-10 ">
                ...
                <div className="headermid mb-[20px] w-full flex-grow-[1] px-4">
                    <form className="headersearchBox flex justify-center items-center outline-0" onSubmit={searchSubmitHandler}>
                        <input
                            type="text"
                            placeholder="Search Amazon.in"
                            onChange={(e) => setKeyword(e.target.value)}
                            className='py-[15px] px-[4px] w-[100%] border rounded-tl-[10px] rounded-tr-none rounded-bl-[10px] rounded-br-none  text-black outline-0'
                        />
                        <button type="submit"
